...
var createNewItem = function createNewItem(data) {
  return $.ajax({
...
var showListItem = function showListItem(listId) {
  return $.ajax({
...
var updateListItem = function updateListItem(listId, data) {
...
var deleteListItem = function deleteListItem(listId) {
  // console.log(listId)
  return $.ajax({
    url: config.apiOrigin + '/list_items/' + listId,
    method: 'DELETE',
...
var signInSuccess = function signInSuccess(response, event) {
  ...
  api.getList().then(onGetListSuccess).catch(onGetListFailure);
};
// function to display my index request
var onGetListSuccess = function onGetListSuccess(data) {
  $('#bucket-list-handlebars').empty();
  var showListItemsHTML = handlebars({ list_items: data.list_items });
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n\n\n<tr data-id=\""
    ...
    + "\">\n    <td class=\"col-sm-10 saved-description\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.item_description : stack1), depth0))
    + "</td>\n    <td class=\"col-xs-3\">\n      <button type=\"button\" data-toggle=\"modal\" data-target=\"#editItemModal\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"btn primary-button edit-button\">Edit</button>\n    </td>\n      <td class=\"col-xs-3\">\n        <button type=\"button\" class=\"delete-item ibtnDel btn delete-button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete</button>\n      </td>\n\n      <br>\n</tr>\n";
...
var bucketListEvents = __webpack_require__(36);
...
var bucketListUi = __webpack_require__(38);

var newListItem = function newListItem(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.createNewItem(data).then(ui.createBucketListSuccess).catch(ui.createBucketListFailure);
};
...
var createBucketListSuccess = function createBucketListSuccess() {
  ...
  api.getList().then(authUi.onGetListSuccess).catch(authUi.onGetListFailure);
  $('#status-message').text('');
};
...
var onLaunchEditModal = function onLaunchEditModal(event) {
  ...
  .then(listShowSuccess).catch(listShowFailure);
};
...
var listShowSuccess = function listShowSuccess(data) {
...
var listShowFailure = function listShowFailure(data) {
  $('#status-message').text('failed to load your selection');
};

// function to display all the list items (i.e refresh list)
var onSubmitUpdateListItem = function onSubmitUpdateListItem(event) {
  event.preventDefault();
  var data = getFormFields(this);
  var id = data.list_item.id;
  // console.log('onSubmitUpdateListItem', id, data)
  api.updateListItem(id, data).then(updateListSuccess).catch(updateListFailure);
};
...
var updateListSuccess = function updateListSuccess(data) {
  ...
  api.getList().then(authEvents.onGetListSuccess).catch(authEvents.onGetListFailure);
};
...
var onDeleteClickButton = function onDeleteClickButton(event) {
  event.preventDefault();
  // console.log(event.target.dataset.id)
  onDeleteListItem(event.target.dataset.id);
};

var onDeleteListItem = function onDeleteListItem(id) {
  event.preventDefault();
  // console.log(id)
  api.deleteListItem(id).then(deleteItemSuccess).catch(deleteItemFailure);
};
var deleteItemSuccess = function deleteItemSuccess(data) {
  api.getList().then(onGetListAfterDeleteSuccess).catch(onGetListAfterDeleteFailure);
  $('#status-message').text('Bucket item deleted successfully!');
};
var onGetListAfterDeleteSuccess = function onGetListAfterDeleteSuccess(data) {
  $('#bucket-list-handlebars').empty();
  var showListItemsHTML = handlebars({ list_items: data.list_items });
  $('#bucket-list-handlebars').html(showListItemsHTML);
  // $('.edit-row').on('submit')
...
var onGetListAfterDeleteFailure = function onGetListAfterDeleteFailure() {
  $('#status-message').text('failed to load your list');
};
...
module.exports = {
  ...
  listShowSuccess: listShowSuccess,
  listShowFailure: listShowFailure,
  updateListSuccess: updateListSuccess,
  updateListFailure: updateListFailure,
  onSubmitUpdateListItem: onSubmitUpdateListItem,
...
// module
exports.push([module.i, "\n/*$black: #000;\n$align-content: center;\n$height: 80px;\n$margin: 30px;*/\n\n#heading {\n  font-family: 'Shadows Into Light', cursive;\n  font-size: 100px;\n  font-weight: bold;\n}\n\nbody {\n  text-align: center;\n  background: url(https://i.imgur.com/4fZ4erC.jpg?1) no-repeat center center fixed;\n  -webkit-background-size: cover;\n  -moz-background-size: cover;\n  -o-background-size: cover;\n  background-size: cover;\n}\n\n.auth-form {\n  text-align: left;\n  margin-left: 85%;\n}\n\nlegend {\n  font-family: 'Caveat', cursive;\n  font-size: 38px;\n  font-weight: bold;\n}\n\n#status-message {\n  font-family: 'Caveat', cursive;\n  font-size: 38px;\n  font-weight: bold;\n}\n\n#bucket-header {\n  font-family: 'Shadows Into Light', cursive;\n  font-size: 45px;\n  font-weight: bold;\n  text-shadow: 2px 2px #b1ecef;\n}\n\n.description {\n  margin: auto;\n}\n\n.saved-description {\n  background-color: rgba(143, 129, 114, .70);\n  font-family: 'Caveat', cursive;\n  font-size: 27px;\n  font-weight: bold;\n  text-align:left;\n  align-content: center;\n}\n\n.add-item-button {\n  background-color: rgba(204, 184, 209, .90);\n}\n\n.primary-button {\nmargin: 5px;\nbackground-color: #B2E3E8;\n}\n\n.delete-button {\nbackground-color: #452B29;\ncolor: #ffffff;\n}\n\n.nav-bar {\n  background-color: #8F8172;\n}\n\n.glyphicon, .nav-link {\n    color: #E6E2DF\n}\n\ntd {\n  border: 3px solid rgba(143, 129, 114, 0);\n}\n\n.edit-modal-text-field {\nwidth: 575px;\nheight: 45px;\n}\n.modal-body {\n  background-color: #E6E2DF;\n}\n.modal-header {\nbackground-color: #8F8172\n}\n.text-box {\n  background-color: rgba(224, 229, 229, .70);\n}\n#item_description {\n  background-color: rgba(224, 229, 229, .90);\n}\n", ""]);
